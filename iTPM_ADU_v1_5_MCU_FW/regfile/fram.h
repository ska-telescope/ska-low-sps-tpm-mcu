...
#define FRAM_THRESHOLD_ENABLE_MASK			0x000000190 //RW - 17 bit
#define FRAM_ALARM_THR_SW_AVDD1				0x000000194 //RW - 32 bit
#define FRAM_ALARM_THR_SW_AVDD2				0x000000198 //RW - 32 bit
#define FRAM_ALARM_THR_AVDD3				0x00000019C //RW - 32 bit
#define FRAM_ALARM_THR_MAN_1V2				0x0000001A0 //RW - 32 bit
#define FRAM_ALARM_THR_DDR0_VREF			0x0000001A4 //RW - 32 bit
#define FRAM_ALARM_THR_DDR1_VREF			0x0000001A8 //RW - 32 bit
#define FRAM_ALARM_THR_VM_DRVDD				0x0000001AC //RW - 32 bit
#define FRAM_ALARM_THR_VIN_SCALED			0x0000001B0 //RW - 32 bit
#define FRAM_ALARM_THR_VM_MAN3V3			0x0000001B4 //RW - 32 bit
#define FRAM_ALARM_THR_VM_MAN1V8			0x0000001B8 //RW - 32 bit
#define FRAM_ALARM_THR_MON_5V0				0x0000001BC //RW - 32 bit
#define FRAM_ALARM_THR_MGT_AV				0x0000001C0 //RW - 32 bit
#define FRAM_ALARM_THR_MGT_AVTT				0x0000001C4 //RW - 32 bit
#define FRAM_ALARM_THR_INTERNAL_MCU_TEMP	0x0000001C8 //RW - 32 bit
#define FRAM_ALARM_THR_BOARD_TEMP			0x0000001CC //RW - 32 bit
#define FRAM_ALARM_THR_FPGA0_TEMP			0x0000001D0 //RW - 32 bit
#define FRAM_ALARM_THR_FPGA1_TEMP			0x0000001D4 //RW - 32 bit
