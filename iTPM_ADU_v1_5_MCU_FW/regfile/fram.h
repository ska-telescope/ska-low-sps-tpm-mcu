...
#define FRAM_MCU_STEP						0x00000038 //RW - 32 bit
#define FRAM_MCU_UART_DBG_DIS				0x00000040 //RW - 32 bit
...
#define ENABLE_ACCESS_CHECK					0x000002C8

#define DBG_ACCESS_CHECK					0x000002D0
