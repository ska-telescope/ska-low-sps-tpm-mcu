...
#define FRAM_ALARM_THR_SW_AVDD1				0x000000068 //RW - 32 bit
#define FRAM_ALARM_THR_SW_AVDD2				0x00000006C //RW - 32 bit
#define FRAM_ALARM_THR_AVDD3				0x000000070 //RW - 32 bit
#define FRAM_ALARM_THR_MAN_1V2				0x000000074 //RW - 32 bit
#define FRAM_ALARM_THR_DDR0_VREF			0x000000078 //RW - 32 bit
#define FRAM_ALARM_THR_DDR1_VREF			0x00000007C //RW - 32 bit
#define FRAM_ALARM_THR_VM_DRVDD				0x000000080 //RW - 32 bit
#define FRAM_ALARM_THR_VIN_SCALED			0x000000084 //RW - 32 bit
#define FRAM_ALARM_THR_VM_MAN3V3			0x000000088 //RW - 32 bit
#define FRAM_ALARM_THR_VM_MAN1V8			0x00000008C //RW - 32 bit
#define FRAM_ALARM_THR_MON_5V0				0x000000090 //RW - 32 bit
#define FRAM_ALARM_THR_MGT_AV				0x000000094 //RW - 32 bit
#define FRAM_ALARM_THR_MGT_AVTT				0x000000098 //RW - 32 bit
#define FRAM_ALARM_THR_INTERNAL_MCU_TEMP	0x00000009C //RW - 32 bit
#define FRAM_ALARM_THR_BOARD_TEMP			0x0000000A0 //RW - 32 bit
#define FRAM_ALARM_THR_FPGA0_TEMP			0x0000000A4 //RW - 32 bit
#define FRAM_ALARM_THR_FPGA1_TEMP			0x0000000A8 //RW - 32 bit 
