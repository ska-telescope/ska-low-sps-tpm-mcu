...
const uint32_t SETTING_WARN_THR_FPGA0_TEMP			= 0xB9B20000;
const uint32_t SETTING_WARN_THR_FPGA1_TEMP			= 0xB9B20000;

const uint32_t SETTING_ALARM_THR_INTERNAL_MCU_TEMP	= 0xEEEE0000;
const uint32_t SETTING_ALARM_THR_BOARD_TEMP			= 0xEEEE0000;
const uint32_t SETTING_ALARM_THR_FPGA0_TEMP			= 0xBECD0000;
const uint32_t SETTING_ALARM_THR_FPGA1_TEMP			= 0xBECD0000;
