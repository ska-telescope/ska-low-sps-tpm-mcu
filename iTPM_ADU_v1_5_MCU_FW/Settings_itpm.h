...
// FPGA FE_CURRENTS
const uint32_t SETTING_WARN_THR_FPGA0_FE_CURRENT	= 0xEEEE0000;
const uint32_t SETTING_WARN_THR_FPGA1_FE_CURRENT	= 0xEEEE0000;

const uint32_t SETTING_ALARM_THR_FPGA0_FE_CURRENT	= 0xEEEE0000;
const uint32_t SETTING_ALARM_THR_FPGA1_FE_CURRENT	= 0xEEEE0000;
