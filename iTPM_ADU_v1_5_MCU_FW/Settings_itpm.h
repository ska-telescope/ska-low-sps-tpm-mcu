...
const uint32_t SETTING_WARN_THR_SW_AVDD1			= 0x04880410; // 1.16 V, 1.04 V
const uint32_t SETTING_WARN_THR_SW_AVDD2			= 0x09740884; // 2.42 V, 2.18 V
const uint32_t SETTING_WARN_THR_AVDD3				= 0x0a280942; // 2.37	2.60
const uint32_t SETTING_WARN_THR_MAN_1V2				= 0x04ec0474; // 1.14	1.26
const uint32_t SETTING_WARN_THR_DDR0_VREF			= 0x0276023a; // 0.57	0.63
const uint32_t SETTING_WARN_THR_DDR1_VREF			= 0x0276023a; // 0.57	0.63
const uint32_t SETTING_WARN_THR_VM_DRVDD			= 0x076206ae; // 1.71	1.89
const uint32_t SETTING_WARN_THR_VIN_SCALED			= 0x31382c88; // 12.60V, 11.40 V 
const uint32_t SETTING_WARN_THR_VM_MAN3V3			= 0x0f280DB6; // 3.51	3.88
const uint32_t SETTING_WARN_THR_VM_MAN1V8			= 0x0834076c; // 1.90	2.10
const uint32_t SETTING_WARN_THR_MON_5V0				= 0x14461252; // 4.69	5.19
const uint32_t SETTING_WARN_THR_MGT_AV				= 0x03ca033e; // 0.83	0.97
const uint32_t SETTING_WARN_THR_MGT_AVTT			= 0x04ec0474; // 1.14	1.26
...
// FPGA FE_CURRENTS
const uint32_t SETTING_WARN_THR_FPGA0_FE_CURRENT	= 0x0A3C0942; // 2.37	2.62
const uint32_t SETTING_WARN_THR_FPGA1_FE_CURRENT	= 0x0A3C0942;
